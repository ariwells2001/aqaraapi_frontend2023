...
def registration(location):
 ...
 #   with st.sidebar.form("Login"):
    with placeholder1.form("Registration"):
        aqaraAccount = st.text_input("Aqara Email Account")
        password = st.text_input("Password", type="password")
    ...
    if submitButton:
        ...
        st.write("Aqara Account has been registered Successfully.")
